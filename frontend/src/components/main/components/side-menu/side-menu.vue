<template>
  <div class="side-menu-wrapper">
    <slot></slot>
    <!-- :open-names="openedNames" :accordion="accordion" -->
    <Menu ref="menu" v-show="!collapsed" :active-name="activeName"  :theme="theme" width="auto" @on-select="handleSelect">
    ...
    <div class="menu-collapsed" v-show="collapsed" :list="menuList">
      <template v-for="item in menuList">
        ...
        <Tooltip transfer v-else :content="item.meta.title" placement="right" :key="`drop-menu-${item.name}`">
